report 50000 "CBR Aged Accounts Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountsReceivableCBR.rdl';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            column(PostingDateTitle; PostingDateTitle)
            {
            }
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(Totals; "Integer")
                {
                    ...
                    column(DueDateFullLbl; DueDateShortLbl)
                    {

                    }
                    column(PostingDate; PostingDateValue)
                    {

                    }
                    column(DueDate; DueDateValue)
                    {
                    ...
                    begin
                        ...
                        IF TempCustLedgEntry1.GET(TempCustLedgEntry."Entry No.") THEN BEGIN
                            PostingDateValue := TempCustLedgEntry1."Posting Date";
                            DueDateValue := TempCustLedgEntry1."Due Date";
                        END;
    ...
    var
        ...
        PostingDateTitle: Label 'Posting Date';
        UpToLbl: Label 'Up To';
        DaysLbl: Label ' Days';
        ...
        TXT_SHEET: Label 'Aged Accounts Receivable';
