report 50002 "Order Confirmation CBR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './OrderConfirmationCBR.rdl';
    ...
    local procedure OnAfterCalculateSalesTax(var SalesHeader: Record "Sales Header";
    var SalesLine: Record "Sales Line";
    var PrepmtSalesLine: Record "Sales Line";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalculateSalesTax(var SalesHeader: Record "Sales Header";
    var SalesLine: Record "Sales Line";
