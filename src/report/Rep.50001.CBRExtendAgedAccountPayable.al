report 50001 "CBR Aged Accounts Payable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountsPayableCBR.rdl';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(Totals; "Integer")
            {
                ...
                begin
                    ...
                    IF TempVendLedgEntry1.GET(TempVendLedgEntry."Entry No.") THEN BEGIN
                        PostingDateValue := TempVendLedgEntry1."Posting Date";
                        DueDateValue := TempVendLedgEntry1."Due Date";
                    END;
    ...
    var
        ...
        TXT_SHEET: Label 'Aged Accounts Payable';
